...
\begin{tabular}{|c|p{9.5cm}|p{1cm}|}
	...
	\hline
	5.1 & Realizar bocetos. & 0.5 \\ \hline
	5.2 &  Implementar la lógica. & 2 \\ \hline
	5.3 &  Implementar la interfaz para la visualización. & 1 \\ \hline
	\multicolumn{3}{|c|}{\textbf{Pruebas de aceptación}} \\ \hline
...
\begin{tabular}{|c|p{9.5cm}|p{1cm}|}
	...
	\hline
	5.1 & Realizar bocetos. & 0.5 \\ \hline
	5.2 &  Implementar la lógica. & 1 \\ \hline
	5.3 &  Implementar la interfaz para la visualización. & 1 \\ \hline
	\multicolumn{3}{|c|}{\textbf{Pruebas de aceptación}} \\ \hline
	1 & \multicolumn{2}{|p{10cm}|}{Comprobar que las solicitudes se envían correctamente.} \\ \hline
...
\begin{tabular}{|c|p{9.5cm}|p{1cm}|}
	...
	\hline
	5.1 & Realizar bocetos & 0.5 \\ \hline
	5.2 &  Implementar la lógica de obtención del perfil & 2 \\ \hline
	5.3 &  Implementar la interfaz para la visualización del perfil & 1 \\ \hline
	\multicolumn{3}{|c|}{\textbf{Pruebas de aceptación}} \\ \hline
	1 & \multicolumn{2}{|p{10cm}|}{} \\ \hline
	2 & \multicolumn{2}{|p{10cm}|}{} \\ \hline
	3 & \multicolumn{2}{|p{10cm}|}{} \\ \hline
...
\begin{tabular}{|c|p{9.5cm}|p{1cm}|}
	...
	5.1 & Realizar bocetos & 0.5 \\ \hline
	5.2 &  Implementar la lógica & 2 \\ \hline
	5.3 &  Implementar la interfaz & 1 \\ \hline
	\multicolumn{3}{|c|}{\textbf{Pruebas de aceptación}} \\ \hline
...
Explicar que es el acta fundacional y para que la necesita la aplicación (ver en marcadores firefox).
